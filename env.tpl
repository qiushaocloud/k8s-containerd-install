...
# calico IP_AUTODETECTION_METHOD 的值，用于指定网卡, 如果为空则表示自动检测节点的 IP 地址, 例如: interface=ens* 或 interface=ens32 或 can-reach=www.baidu.com 【注：使用 interface=ens32 需要所有机器上的网卡都是ens32，否则请使用 interface=ens*】
